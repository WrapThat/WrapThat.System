...
void Copy(string sourceFileName,string destFileName,System.Boolean overwrite);
System.IO.FileStream Create(string path);
System.IO.FileStream Create(string path,System.Int32 bufferSize);
void Create(string path,System.Int32 bufferSize,System.IO.FileOptions options);
void Create(string path,System.Int32 bufferSize,System.IO.FileOptions options,System.Security.AccessControl.FileSecurity fileSecurity);
...
void Replace(string sourceFileName,string destinationFileName,string destinationBackupFileName,System.Boolean ignoreMetadataErrors);
