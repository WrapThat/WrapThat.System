...
public void Copy(string sourceFileName,string destFileName,System.Boolean overwrite) => System.IO.File.Copy(sourceFileName,destFileName,overwrite);
public System.IO.FileStream Create(string path) => System.IO.File.Create(path);
public System.IO.FileStream Create(string path,System.Int32 bufferSize) => System.IO.File.Create(path,bufferSize);
public void Create(string path,System.Int32 bufferSize,System.IO.FileOptions options) => System.IO.File.Create(path,bufferSize,options);
public void Create(string path,System.Int32 bufferSize,System.IO.FileOptions options,System.Security.AccessControl.FileSecurity fileSecurity) => System.IO.File.Create(path,bufferSize,options,fileSecurity);
...
public void Exists(string path) => System.IO.File.Exists(path);
...
public void Replace(string sourceFileName,string destinationFileName,string destinationBackupFileName,System.Boolean ignoreMetadataErrors) => System.IO.File.Replace(sourceFileName,destinationFileName,destinationBackupFileName,ignoreMetadataErrors);
