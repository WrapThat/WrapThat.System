...
public System.Collections.Generic.IEnumerable`1[[string, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]] EnumerateDirectories(string path)  => System.IO.Directory.EnumerateDirectories(path);
public System.Collections.Generic.IEnumerable`1[[string, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]] EnumerateDirectories(string path,string searchPattern)  => System.IO.Directory.EnumerateDirectories(path,searchPattern);
public System.Collections.Generic.IEnumerable`1[[string, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]] EnumerateDirectories(string path,string searchPattern,System.IO.SearchOption searchOption)  => System.IO.Directory.EnumerateDirectories(path,searchPattern,searchOption);
public System.Collections.Generic.IEnumerable`1[[string, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]] EnumerateFiles(string path)  => System.IO.Directory.EnumerateFiles(path);
public System.Collections.Generic.IEnumerable`1[[string, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]] EnumerateFiles(string path,string searchPattern)  => System.IO.Directory.EnumerateFiles(path,searchPattern);
public System.Collections.Generic.IEnumerable`1[[string, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]] EnumerateFiles(string path,string searchPattern,System.IO.SearchOption searchOption)  => System.IO.Directory.EnumerateFiles(path,searchPattern,searchOption);
public System.Collections.Generic.IEnumerable`1[[string, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]] EnumerateFileSystemEntries(string path)  => System.IO.Directory.EnumerateFileSystemEntries(path);
public System.Collections.Generic.IEnumerable`1[[string, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]] EnumerateFileSystemEntries(string path,string searchPattern)  => System.IO.Directory.EnumerateFileSystemEntries(path,searchPattern);
public System.Collections.Generic.IEnumerable`1[[string, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]] EnumerateFileSystemEntries(string path,string searchPattern,System.IO.SearchOption searchOption)  => System.IO.Directory.EnumerateFileSystemEntries(path,searchPattern,searchOption);
